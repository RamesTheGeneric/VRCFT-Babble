...
namespace Collections
{
    ...
    public class TwoKeyDictionary<TKey1, TKey2, TValue>
    {
        ...
        /// <param name="value"></param>
        /// <returns>Returns true if the value was set, false if the value was not found.</returns>
        public bool TrySetByKey1(TKey1 key1, TValue value)
        {
        ...
        /// <param name="value"></param>
        /// <returns>Returns true if the value was set, false if the value was not found.</returns>
        public bool TrySetByKey2(TKey2 key2, TValue value)
        {
        ...
        /// <param name="key1"></param>
        /// <param name="value"></param>
        public void SetByKey1(TKey1 key1, TValue value)
        {
            m_dic2[m_dic1[key1]] = value;
        }
        ...
        /// <param name="key2"></param>
        /// <param name="value"></param>
        public void SetByKey2(TKey2 key2, TValue value)
        {
            m_dic2[key2] = value;
        }
